...
#  Usage: ./auto_transfer_no_db.sh BLOG_NAME
###
...
zip ${BLOG_NAME}_${DATE}_ALL.zip ${BLOG_NAME}_${DATE}.zip ${BLOG_DEFAULT_VHOST_NAME}.conf ssl_${BLOG_NAME}.zip> /dev/null

rm -rf ${BLOG_NAME}_${DATE}.zip ${BLOG_DEFAULT_VHOST_NAME}.conf ssl_${BLOG_NAME}.zip
